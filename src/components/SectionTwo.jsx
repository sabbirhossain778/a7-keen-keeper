...
const SectionTwo = ({ friend }) => {
    ...
    return (
        <div className='mt-8 space-y-4 md:space-y-6'>
             ...
             {/* First Line */}
            <div className='First-Line flex flex-3 justify-between gap-4'>
                <div className="card bg-base-100 shadow-sm flex-1">
                    <div className="card-body text-center items-center">
                        <h2 className="card-title text-2xl md:text-3xl font-semibold">{days_since_contact}</h2>
                        <p className='text-[#64748b] text-[18px]'>Days Since Contact</p>
                    </div>
                </div>
                <div className="card bg-base-100 shadow-sm flex-1">
                    <div className="card-body text-center items-center">
                        <h2 className="card-title text-2xl md:text-3xl font-semibold">{goal}</h2>
                        <p className='text-[#64748b] text-[18px]'>Goal (Days)</p>
                    </div>
                </div>
                <div className="card bg-base-100 shadow-sm flex-1">
                    <div className="card-body text-center items-center">
                        <h2 className="card-title text-2xl md:text-3xl font-semibold">{next_due_date}</h2>
